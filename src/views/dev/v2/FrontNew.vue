...
const submit = async () => {
    ...
    result.value.front = await FrontViewV2(tableId, tableName)
    result.value.index = await Index(tableId, tableName)
    result.value.table = await FrontTableV2(tableId, tableName)
    result.value.formDialog = await FrontFormDialogV2(tableId, tableName)
    ...
    <Fluid>
        <div class="">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Frontend New</div>
                ...
                <Tabs value="0">
                    <TabList>
                        <Tab value="0">FrontView</Tab>
                        <Tab value="1">FrontTable</Tab>
                        <Tab value="2">FrontFormDialog</Tab>
                        <Tab value="3">Index</Tab>
                    </TabList>
                    <TabPanels>
                        <TabPanel value="0">
                            <pre>
